...
import { addToStores, removeItem } from '../rtk/reducers/storesReducer';
                    ...
                    <Card className='mx-2 mx-md-0 rounded-3 product-curd'>
                        <div className='overflow-hidden position-relative'>
                            ...
                            <div className='loved-btn bg-secondary'>
                                <button className='bg-transparent' onClick={() => handleAddToStores(product, product.id)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={23} 
                                        fill={`${clickedButtons[product.id] ? "red" : "white"}`}
                                    >
                            ...
                            <div className='quick-view'>
                                <button className='w-100 bg-transparent fw-semibold py-2' onClick={() => handleAddToCart(product, product.id)}>
